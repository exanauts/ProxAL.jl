...
algparams.optimizer_fullmodel = ()->MadNLP.Optimizer(linear_solver="Mumps",log_level="info",max_iter=100) 
algparams.optimizer_proxALM = ()->MadNLP.Optimizer(linear_solver="Mumps",log_level="info",max_iter=100)
