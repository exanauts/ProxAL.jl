...
algparams.optimizer_fullmodel = optimizer_fullmodel = optimizer_with_attributes(Ipopt.Optimizer, "print_level" => Int64(algparams.verbose > 0)*5)
algparams.optimizer_proxALM = optimizer_with_attributes(Ipopt.Optimizer, "print_level" => Int64(algparams.verbose > 0)*5)
