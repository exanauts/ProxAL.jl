...
@testset "$T-period, $K-ctgs, time_link=penalty" begin
    ...
    @testset "Non-decomposed formulation" begin
        ...
        optimizer = optimizer_with_attributes(Ipopt.Optimizer, "print_level" => Int64(algparams.verbose > 0)*5)

        result = solve_fullmodel(opfdata, rawdata, optimizer; modelinfo = modelinfo, algparams = algparams)
    ...
    @testset "ProxALM" begin
        ...
        runinfo = run_proxALM(opfdata, rawdata, optimizer; modelinfo = modelinfo, algparams = algparams)
